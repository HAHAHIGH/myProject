                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">
                            <img src="pics/bookIcon.png" alt="logo" /></a>
                    </div>
                    <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav navbar-left">
                            <li><a href="index.aspx">
                                <asp:Image ID="Image2" runat="server" ImageUrl="~/pics/homeIcom.png" Width="20px" Height="20px" />Home</a></li>
                            <li><a href="#">
        ...
        <table  class="pictureTable">
            ...
            <tr>
                ...
                <td rowspan="2" class="gridviewStyle">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateDeleteButton="True" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" OnRowDeleting="GridView1_RowDeleting">
